        ...
        <v-container id="body_content">
            <v-row>
                ...
                <div id="start_top_head">
                    <h1>Retrieving Files (API Endpoint)</h1>
                    <p id="doc_intro">
                        The file retrieval url endpoint is used to retrieve uploaded files from cloudiby.
                        Retrieving files requires you to make use of your developer API key
                        ( For more info about the developer API key, click this <router-link style="color: rgb(22, 71, 225);" to="/api_keys">link</router-link> ).
                        This is the file retrieval url endpoint: <a href="https://api.cloudiby.com/retrieve">https://api.cloudiby.com/retrieve</a>.
                        This endpoint makes use of only the POST request method type. The retrieve file url endpoint
                        only requires one parameter and that is the doc id of the file that you want to retrieve ( For more info about the doc id, click this <router-link style="color: rgb(22, 71, 225);" to="/api-url-endpoints/upload_file">link</router-link> ).
                    </p>
                    <p id="doc_intro">Below is a complete example on how to use the file retrieval API endpoint:</p>
                    <div>
                        <iframe width="100%" height="300" src="//jsfiddle.net/Michael220/k8cm1p7u/36/embedded/js,html/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
                    </div>
                    <v-alert
                        border="left"
                        colored-border
                ...
                <div id="start_top_body">
                    ...
                    <p id="doc_intro" style="margin-top: 0px">
                        Now that you have successfully learned how to make use of the file retrieval API endpoint,
                        you can now proceed to learn about the delete file API endpont by clicking
                        the button below:
                    </p>
                    <p id="doc_intro" style="margin-bottom: 0px;">
                        <router-link to="/api-url-endpoints/delete_file" style="text-decoration: none;">
                            <v-btn
                                color="rgb(22, 71, 225)"
...
export default {
     metaInfo() {
        return {
            title: "Retrieve File | Cloudiby Developer Documentation",
            meta: [
                ...
                { property: 'og:title', content: "Retrieve File | Cloudiby Developer Documentation"},
    ...
    data(){
        return {
            nav_items: this.$store.state.retrieve_endpoint_page,
            right: null,
            loader: null,
            loading: false,
            loading2: false,
    ...
    mounted(){
        this.$nextTick(() => {
            document.title = 'Retrieve File | Cloudiby Developer Documentation'
        });
    }
}
</script>
