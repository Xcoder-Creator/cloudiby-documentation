        ...
        <v-container id="body_content">
            <v-row>
                ...
                <div id="start_top_head">
                    <h1>Uploading Files (API Endpoint)</h1>
                    <p id="doc_intro">
                        The file upload url endpoint is used to upload files to cloudiby.
                        Uploading files requires you to make use of your developer API key
                        ( For more info about the developer API key, click this <router-link style="color: rgb(22, 71, 225);" to="/api_keys">link</router-link> ).
                        This is the file upload url endpoint: <a href="https://api.cloudiby.com/upload">https://api.cloudiby.com/upload</a>.
                        This endpoint makes use of only the POST request method type. The file upload url endpoint
                        only requires one parameter and that is the files parameter which will contain all the files that you want to upload.
                    </p>
                    <p id="doc_intro">Below is a complete example on how to use the file upload API endpoint:</p>
                    <div>
                        <iframe width="100%" height="300" src="//jsfiddle.net/Michael220/k8cm1p7u/34/embedded/js,html/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
                    </div>
                    <v-alert
                        border="left"
                        colored-border
                    ...
                    <h2 id="quick_guide_txt">Doc id</h2>
                    <p id="doc_intro" style="margin-top: 0px">
                        When you send a valid request to the upload file endpoint, you should
                        get a JSON response back. Part of the JSON response should be the doc id.
                        The doc id ( Document ID ) is a unique id that belongs to the file that you uploaded. Every file
                        that you upload to cloudiby has a different unique doc id. The doc id is very important and
                        will be used with other endpoints for different operations ( Eg: Retrieving files and deleting files ).
                        It can be stored in your local database in order to retrieve your files at any time.
                    </p>
                </div>
                <div id="start_top_body">
                    <h2 id="quick_guide_txt" style="margin-top: 20px;">Conclusion</h2>
                    <p id="doc_intro" style="margin-top: 0px">
                        Now that you have successfully learned how to make use of the file upload API endpoint,
                        you can now proceed to learn about the file retrieval API endpont by clicking
                        the button below:
                    </p>
                    <p id="doc_intro" style="margin-bottom: 0px;">
                        <router-link to="/api-url-endpoints/retrieve_file" style="text-decoration: none;">
                            <v-btn
                                color="rgb(22, 71, 225)"
...
export default {
         metaInfo() {
        return {
            title: "Upload File | Cloudiby Developer Documentation",
            meta: [
                ...
                { property: 'og:title', content: "Upload File | Cloudiby Developer Documentation"},
    ...
    data(){
        return {
            nav_items: this.$store.state.upload_endpoint_page,
            right: null,
            loader: null,
            loading: false,
            loading2: false,
    ...
    mounted(){
        this.$nextTick(() => {
            document.title = 'Upload File | Cloudiby Developer Documentation'
        });
    }
}
</script>
